  ...
  return (
    <section className="relative pt-28 pb-20 md:pb-28 md:pt-36">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute inset-0 bg-gradient-to-r from-corporate-blue/90 to-corporate-green/70 z-10"></div>
        <img
      ...
      <div className="container-custom relative z-20">
        <div className="max-w-3xl text-white">
          ...
          <p className="text-xl md:text-2xl mb-8 animate-fade-in opacity-90" style={{ animationDelay: '0.2s' }}>
            We connect businesses with exceptional talent and help job seekers shape successful careers.
          </p>
